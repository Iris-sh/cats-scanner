...
#include "../include/cats_scaner_delimiter_table.h"
...
namespace cats_scanner{
    static const Segment_with_value<char32_t, uint64_t> categories_table[] = {
        ...
        {{U'a', U'a'},  4108      },    {{U'2', U'7'},  1093640   },    {{U'А', U'б'},  12        },  
    {{U'(', U'*'},  32        },    {{U'G', U'N'},  12        },    {{U'p', U'p'},  12        },    
    {{U'ч', U'ь'},  12        },  {{U'#', U'#'},  32        },    {{U'.', U'.'},  2097184   },    
    {{U'B', U'B'},  4364      },    {{U'Y', U'Z'},  12        },    {{U'e', U'e'},  135180    },    
    {{U'y', U'y'},  12        },    {{U'й', U'й'},  12        },  {{U'ю', U'я'},  12        },  
    {{U'!', U'!'},  32        },    {{U'%', U'&'},  32        },    {{U',', U','},  32        },    
    {{U'0', U'0'},  126984    },    {{U':', U'@'},  32        },    {{U'E', U'E'},  135180    },    
    {{U'P', U'W'},  12        },    {{U']', U'^'},  32        },    {{U'c', U'c'},  4108      },    
    {{U'g', U'n'},  12        },    {{U'r', U'w'},  12        },    {{U'{', U'~'},  32        },    
    {{U'ж', U'ж'},  12        },  {{U'х', U'х'},  12        },  {{U'э', U'э'},  28        },  
    ...
    {{U'q', U'q'},  524300    },    {{U'x', U'x'},  524428    },    {{U'z', U'z'},  28        },    
    {{U'Ё', U'Ё'},  12        },  {{U'в', U'е'},  28        },  {{U'з', U'и'},  28        },  
    {{U'к', U'ф'},  28        },  {{U'ц', U'ц'},  28        }
    };
...
//         bool t = (this->*char_procs_[state_ + 1])();
    ...
    ascaner::Token<cats_scanner::Lexeme_info> Scanner::current_lexeme()
    {
        automaton_           = Automaton_name::Start;
        token_.lexeme_.code_ = Lexem_code::Nothing;
        lexeme_begin_        = loc_->pcurrent_char_;
    ...
    std::string Scanner::lexeme_to_string(const cats_scanner::Lexeme_info& li)
    {
        std::string result;
        auto        lc     = li.code_;
