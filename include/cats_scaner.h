/*
    ...
    E-mails: vladimir.s.gavrilov@gmail.com
             ...
             gavvs1977@yandex.ru
*/
#ifndef CATS_SCANER_H
#define CATS_SCANER_H
#   include "../include/cats_lexeme.h"
#   include "../include/abstract_scaner.h"
#   include "../include/category.h"
namespace cats_scanner{
    using cats_token = ascaner::Token<cats_scanner::Lexeme_info>;

    class Scanner : public ascaner::Abstract_scaner<cats_scanner::Lexeme_info>{
    public:
        Scanner()               = default;
        Scanner(const ascaner::Location_ptr& location, const Errors_and_tries& et) :
            ascaner::Abstract_scaner<cats_scanner::Lexeme_info>(location, et) {};
        Scanner(const Scanner&) = default;
        virtual ~Scanner()      = default;

        ascaner::Token<cats_scanner::Lexeme_info> current_lexeme() override;

        std::string lexeme_to_string(const cats_scanner::Lexeme_info& li) override;
    private:
